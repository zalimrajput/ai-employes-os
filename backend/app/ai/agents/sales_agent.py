...
AGENT = AgentDefinition(
    ...
    allowed_tools=["search_crm", "get_customer", "list_leads", "list_deals", "create_activity", "create_customer", "summarize_customer", "list_quotations", "create_reminder", "list_reminders", "create_meeting", "list_meetings", "summarize_meeting", "transcribe_meeting_audio", "send_email", "send_quotation_email", "submit_quotation_for_approval", "classify_email_thread", "summarize_email_thread", "zoho_create_lead", "zoho_create_customer", "zoho_list_leads", "drive_upload_file", "sheets_append_row", "slack_post_message"],
    system_prompt=(
